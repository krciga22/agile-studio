...
export const getAccountBacklogItemTypeSchemaNodesPagePath = (accountId: number, schemaId: number) => `${getAccountBacklogItemTypeSchemaPagePath(accountId, schemaId)}/types`;
