...
type BacklogItemLinkTypesPageProps = {
  accountId: number
}

function BacklogItemLinkTypesPage(props: BacklogItemLinkTypesPageProps) {
  ...
  useEffect(() => {
    if(account){
      Utils.setDocumentTitle(`Backlog Item Link Types - ${getAccountTitle(account)}`);
    }
  }, [account]);
  ...
  return (
    <div className={"BacklogItemLinkTypesPage"}>
...
export default BacklogItemLinkTypesPage;
