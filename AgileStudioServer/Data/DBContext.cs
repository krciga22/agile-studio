    ...
    public class DBContext : DbContext
    {
        ...
        private void SeedAccountOwnerRolePermissions(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<RolePermission>().HasData(
                ...
                new RolePermission(roleKey, PermissionKeys.LIST, Scopes.ACCOUNT_BACKLOG_ITEM_TYPE_SCHEMA_NODE)
                {
                    CreatedOn = new DateTime(2025, 7, 04, 0, 0, 0, DateTimeKind.Utc),
                    IsSystemRolePermission = true
                },
                new RolePermission(roleKey, PermissionKeys.CREATE, Scopes.ACCOUNT_BACKLOG_ITEM_TYPE_SCHEMA_NODE)
                {
                    CreatedOn = new DateTime(2025, 7, 04, 0, 0, 0, DateTimeKind.Utc),
                    IsSystemRolePermission = true
                },
                new RolePermission(roleKey, PermissionKeys.READ, Scopes.ACCOUNT_BACKLOG_ITEM_TYPE_SCHEMA_NODE)
                {
                    CreatedOn = new DateTime(2025, 7, 04, 0, 0, 0, DateTimeKind.Utc),
                    IsSystemRolePermission = true
                },
                new RolePermission(roleKey, PermissionKeys.UPDATE, Scopes.ACCOUNT_BACKLOG_ITEM_TYPE_SCHEMA_NODE)
                {
                    CreatedOn = new DateTime(2025, 7, 04, 0, 0, 0, DateTimeKind.Utc),
                    IsSystemRolePermission = true
                },
                new RolePermission(roleKey, PermissionKeys.DELETE, Scopes.ACCOUNT_BACKLOG_ITEM_TYPE_SCHEMA_NODE)
                {
                    CreatedOn = new DateTime(2025, 7, 04, 0, 0, 0, DateTimeKind.Utc),
                    IsSystemRolePermission = true
                },
                new RolePermission(roleKey, PermissionKeys.LIST, Scopes.ACCOUNT_BACKLOG_ITEM_TYPE_SCHEMA_EDGE)
                {
                    CreatedOn = new DateTime(2025, 7, 04, 0, 0, 0, DateTimeKind.Utc),
                    IsSystemRolePermission = true
                },
                new RolePermission(roleKey, PermissionKeys.CREATE, Scopes.ACCOUNT_BACKLOG_ITEM_TYPE_SCHEMA_EDGE)
                {
                    CreatedOn = new DateTime(2025, 7, 04, 0, 0, 0, DateTimeKind.Utc),
                    IsSystemRolePermission = true
                },
                new RolePermission(roleKey, PermissionKeys.READ, Scopes.ACCOUNT_BACKLOG_ITEM_TYPE_SCHEMA_EDGE)
                {
                    CreatedOn = new DateTime(2025, 7, 04, 0, 0, 0, DateTimeKind.Utc),
                    IsSystemRolePermission = true
                },
                new RolePermission(roleKey, PermissionKeys.UPDATE, Scopes.ACCOUNT_BACKLOG_ITEM_TYPE_SCHEMA_EDGE)
                {
                    CreatedOn = new DateTime(2025, 7, 04, 0, 0, 0, DateTimeKind.Utc),
                    IsSystemRolePermission = true
                },
                new RolePermission(roleKey, PermissionKeys.DELETE, Scopes.ACCOUNT_BACKLOG_ITEM_TYPE_SCHEMA_EDGE)
                {
                    CreatedOn = new DateTime(2025, 7, 04, 0, 0, 0, DateTimeKind.Utc),
                    IsSystemRolePermission = true
                },
                new RolePermission(roleKey, PermissionKeys.LIST, Scopes.ACCOUNT_BACKLOG_ITEM_LINK_TYPE)
                {
                    CreatedOn = new DateTime(2025, 8, 03, 0, 0, 0, DateTimeKind.Utc),
                    IsSystemRolePermission = true
                },
                new RolePermission(roleKey, PermissionKeys.CREATE, Scopes.ACCOUNT_BACKLOG_ITEM_LINK_TYPE)
                {
                    CreatedOn = new DateTime(2025, 8, 03, 0, 0, 0, DateTimeKind.Utc),
                    IsSystemRolePermission = true
                },
                new RolePermission(roleKey, PermissionKeys.READ, Scopes.ACCOUNT_BACKLOG_ITEM_LINK_TYPE)
                {
                    CreatedOn = new DateTime(2025, 8, 03, 0, 0, 0, DateTimeKind.Utc),
                    IsSystemRolePermission = true
                },
                new RolePermission(roleKey, PermissionKeys.UPDATE, Scopes.ACCOUNT_BACKLOG_ITEM_LINK_TYPE)
                {
                    CreatedOn = new DateTime(2025, 8, 03, 0, 0, 0, DateTimeKind.Utc),
                    IsSystemRolePermission = true
                },
                new RolePermission(roleKey, PermissionKeys.DELETE, Scopes.ACCOUNT_BACKLOG_ITEM_LINK_TYPE)
                {
                    CreatedOn = new DateTime(2025, 8, 03, 0, 0, 0, DateTimeKind.Utc),
                    IsSystemRolePermission = true
                },
                new RolePermission(roleKey, PermissionKeys.LIST, Scopes.ACCOUNT_BACKLOG_ITEM_LINK_TYPE_SCHEMA)
                {
                    CreatedOn = new DateTime(2025, 8, 03, 0, 0, 0, DateTimeKind.Utc),
                    IsSystemRolePermission = true
                },
                new RolePermission(roleKey, PermissionKeys.CREATE, Scopes.ACCOUNT_BACKLOG_ITEM_LINK_TYPE_SCHEMA)
                {
                    CreatedOn = new DateTime(2025, 8, 03, 0, 0, 0, DateTimeKind.Utc),
                    IsSystemRolePermission = true
                },
                new RolePermission(roleKey, PermissionKeys.READ, Scopes.ACCOUNT_BACKLOG_ITEM_LINK_TYPE_SCHEMA)
                {
                    CreatedOn = new DateTime(2025, 8, 03, 0, 0, 0, DateTimeKind.Utc),
                    IsSystemRolePermission = true
                },
                new RolePermission(roleKey, PermissionKeys.UPDATE, Scopes.ACCOUNT_BACKLOG_ITEM_LINK_TYPE_SCHEMA)
                {
                    CreatedOn = new DateTime(2025, 8, 03, 0, 0, 0, DateTimeKind.Utc),
                    IsSystemRolePermission = true
                },
                new RolePermission(roleKey, PermissionKeys.DELETE, Scopes.ACCOUNT_BACKLOG_ITEM_LINK_TYPE_SCHEMA)
                {
                    CreatedOn = new DateTime(2025, 8, 03, 0, 0, 0, DateTimeKind.Utc),
                    IsSystemRolePermission = true
                },
                new RolePermission(roleKey, PermissionKeys.LIST, Scopes.ACCOUNT_BACKLOG_ITEM_LINK_TYPE_SCHEMA_ENTRY)
                {
                    CreatedOn = new DateTime(2025, 8, 03, 0, 0, 0, DateTimeKind.Utc),
                    IsSystemRolePermission = true
                },
                new RolePermission(roleKey, PermissionKeys.CREATE, Scopes.ACCOUNT_BACKLOG_ITEM_LINK_TYPE_SCHEMA_ENTRY)
                {
                    CreatedOn = new DateTime(2025, 8, 03, 0, 0, 0, DateTimeKind.Utc),
                    IsSystemRolePermission = true
                },
                new RolePermission(roleKey, PermissionKeys.READ, Scopes.ACCOUNT_BACKLOG_ITEM_LINK_TYPE_SCHEMA_ENTRY)
                {
                    CreatedOn = new DateTime(2025, 8, 03, 0, 0, 0, DateTimeKind.Utc),
                    IsSystemRolePermission = true
                },
                new RolePermission(roleKey, PermissionKeys.DELETE, Scopes.ACCOUNT_BACKLOG_ITEM_LINK_TYPE_SCHEMA_ENTRY)
                {
                    CreatedOn = new DateTime(2025, 8, 03, 0, 0, 0, DateTimeKind.Utc),
                    IsSystemRolePermission = true
                },
                new RolePermission(roleKey, PermissionKeys.LIST, Scopes.ACCOUNT_WORKFLOW)
                {
                    CreatedOn = new DateTime(2026, 7, 11, 0, 0, 0, DateTimeKind.Utc),
                    IsSystemRolePermission = true
                },
                new RolePermission(roleKey, PermissionKeys.CREATE, Scopes.ACCOUNT_WORKFLOW)
                {
                    CreatedOn = new DateTime(2026, 7, 11, 0, 0, 0, DateTimeKind.Utc),
                    IsSystemRolePermission = true
                },
                new RolePermission(roleKey, PermissionKeys.READ, Scopes.ACCOUNT_WORKFLOW)
                {
                    CreatedOn = new DateTime(2026, 7, 11, 0, 0, 0, DateTimeKind.Utc),
                    IsSystemRolePermission = true
                },
                new RolePermission(roleKey, PermissionKeys.UPDATE, Scopes.ACCOUNT_WORKFLOW)
                {
                    CreatedOn = new DateTime(2026, 7, 11, 0, 0, 0, DateTimeKind.Utc),
                    IsSystemRolePermission = true
                },
                new RolePermission(roleKey, PermissionKeys.DELETE, Scopes.ACCOUNT_WORKFLOW)
                {
                    CreatedOn = new DateTime(2026, 7, 11, 0, 0, 0, DateTimeKind.Utc),
                    IsSystemRolePermission = true
                },
        ...
        private void SeedProjectAdminRolePermissions(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<RolePermission>().HasData(
                ...
                new RolePermission(roleKey, PermissionKeys.LIST, Scopes.PROJECT_BACKLOG_ITEM_TYPE_SCHEMA)
                {
                    CreatedOn = new DateTime(2026, 7, 6, 0, 0, 0, DateTimeKind.Utc),
                    IsSystemRolePermission = true
                },
                new RolePermission(roleKey, PermissionKeys.READ, Scopes.PROJECT_BACKLOG_ITEM_TYPE_SCHEMA)
                {
                    CreatedOn = new DateTime(2026, 7, 6, 0, 0, 0, DateTimeKind.Utc),
                    IsSystemRolePermission = true
                },
                new RolePermission(roleKey, PermissionKeys.LIST, Scopes.PROJECT_BACKLOG_ITEM_TYPE_SCHEMA_NODE)
                {
                    CreatedOn = new DateTime(2026, 7, 6, 0, 0, 0, DateTimeKind.Utc),
                    IsSystemRolePermission = true
                },
                new RolePermission(roleKey, PermissionKeys.READ, Scopes.PROJECT_BACKLOG_ITEM_TYPE_SCHEMA_NODE)
                {
                    CreatedOn = new DateTime(2026, 7, 6, 0, 0, 0, DateTimeKind.Utc),
                    IsSystemRolePermission = true
                },
                new RolePermission(roleKey, PermissionKeys.LIST, Scopes.PROJECT_BACKLOG_ITEM_TYPE_SCHEMA_EDGE)
                {
                    CreatedOn = new DateTime(2026, 7, 6, 0, 0, 0, DateTimeKind.Utc),
                    IsSystemRolePermission = true
                },
                new RolePermission(roleKey, PermissionKeys.READ, Scopes.PROJECT_BACKLOG_ITEM_TYPE_SCHEMA_EDGE)
                {
                    CreatedOn = new DateTime(2026, 7, 6, 0, 0, 0, DateTimeKind.Utc),
                    IsSystemRolePermission = true
                },
                new RolePermission(roleKey, PermissionKeys.LIST, Scopes.PROJECT_BACKLOG_ITEM_LINK_TYPE)
                {
                    CreatedOn = new DateTime(2026, 8, 8, 0, 0, 0, DateTimeKind.Utc),
                    IsSystemRolePermission = true
                },
                new RolePermission(roleKey, PermissionKeys.READ, Scopes.PROJECT_BACKLOG_ITEM_LINK_TYPE)
                {
                    CreatedOn = new DateTime(2026, 8, 8, 0, 0, 0, DateTimeKind.Utc),
                    IsSystemRolePermission = true
                },
                ...
                new RolePermission(roleKey, PermissionKeys.LIST, Scopes.PROJECT_BACKLOG_ITEM_STATUS)
                {
                    CreatedOn = new DateTime(2026, 8, 9, 0, 0, 0, DateTimeKind.Utc),
                    IsSystemRolePermission = true
                },
                new RolePermission(roleKey, PermissionKeys.CREATE, Scopes.PROJECT_BACKLOG_ITEM_STATUS)
                {
                    CreatedOn = new DateTime(2026, 8, 9, 0, 0, 0, DateTimeKind.Utc),
                    IsSystemRolePermission = true
                },
                new RolePermission(roleKey, PermissionKeys.READ, Scopes.PROJECT_BACKLOG_ITEM_STATUS)
                {
                    CreatedOn = new DateTime(2026, 8, 9, 0, 0, 0, DateTimeKind.Utc),
                    IsSystemRolePermission = true
                },
                ...
                new RolePermission(roleKey, PermissionKeys.LIST, Scopes.PROJECT_BACKLOG_ITEM_WORKFLOW_STATE)
                {
                    CreatedOn = new DateTime(2026, 8, 9, 0, 0, 0, DateTimeKind.Utc),
                    IsSystemRolePermission = true
                },
                new RolePermission(roleKey, PermissionKeys.READ, Scopes.PROJECT_BACKLOG_ITEM_WORKFLOW_STATE)
                {
                    CreatedOn = new DateTime(2026, 8, 9, 0, 0, 0, DateTimeKind.Utc),
                    IsSystemRolePermission = true
                },
