...
namespace AgileStudioServer.Migrations
{
    ...
    [Migration("20250326024911_Create-Backlog-Item-Link-Type-Schema-Entity")]
    partial class CreateBacklogItemLinkTypeSchemaEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AgileStudioServer.CoreFeatures.BacklogItems.Repositories.Entities.BacklogItem", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AgileStudioServer.CoreFeatures.BacklogItems.Repositories.Entities.BacklogItemLinkType", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AgileStudioServer.CoreFeatures.BacklogItems.Repositories.Entities.BacklogItemLinkTypeSchema", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AgileStudioServer.CoreFeatures.BacklogItems.Repositories.Entities.BacklogItemType", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AgileStudioServer.CoreFeatures.BacklogItems.Repositories.Entities.BacklogItemTypeSchema", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AgileStudioServer.CoreFeatures.BacklogItems.Repositories.Entities.ChildBacklogItemType", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AgileStudioServer.CoreFeatures.Projects.Repositories.Entities.Project", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AgileStudioServer.CoreFeatures.Releases.Repositories.Entities.Release", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AgileStudioServer.CoreFeatures.Sprints.Repositories.Entities.Sprint", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AgileStudioServer.CoreFeatures.Users.Repositories.Entities.User", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AgileStudioServer.CoreFeatures.Workflows.Repositories.Entities.Workflow", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AgileStudioServer.CoreFeatures.Workflows.Repositories.Entities.WorkflowState", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AgileStudioServer.CoreFeatures.BacklogItems.Repositories.Entities.BacklogItem", b =>
                {
                    b.HasOne("AgileStudioServer.CoreFeatures.BacklogItems.Repositories.Entities.BacklogItemType", "BacklogItemType")
                        .WithMany()
                    ...
                    b.HasOne("AgileStudioServer.CoreFeatures.Users.Repositories.Entities.User", "CreatedBy")
                        .WithMany()
                        .HasForeignKey("CreatedByID")
                        .HasConstraintName("fk_backlog_item_user_created_by_id");

                    b.HasOne("AgileStudioServer.CoreFeatures.BacklogItems.Repositories.Entities.BacklogItem", "ParentBacklogItem")
                        .WithMany()
                        .HasForeignKey("ParentBacklogItemId")
                        .HasConstraintName("fk_backlog_item_parent_backlog_item_id");

                    b.HasOne("AgileStudioServer.CoreFeatures.Projects.Repositories.Entities.Project", "Project")
                        .WithMany()
                    ...
                    b.HasOne("AgileStudioServer.CoreFeatures.Releases.Repositories.Entities.Release", "Release")
                        .WithMany()
                        .HasForeignKey("ReleaseID")
                        .HasConstraintName("fk_backlog_item_release_release_id");

                    b.HasOne("AgileStudioServer.CoreFeatures.Sprints.Repositories.Entities.Sprint", "Sprint")
                        .WithMany()
                        .HasForeignKey("SprintID")
                        .HasConstraintName("fk_backlog_item_sprint_sprint_id");

                    b.HasOne("AgileStudioServer.CoreFeatures.Workflows.Repositories.Entities.WorkflowState", "WorkflowState")
                        .WithMany()
            ...
            modelBuilder.Entity("AgileStudioServer.CoreFeatures.BacklogItems.Repositories.Entities.BacklogItemType", b =>
                {
                    b.HasOne("AgileStudioServer.CoreFeatures.BacklogItems.Repositories.Entities.BacklogItemTypeSchema", "BacklogItemTypeSchema")
                        .WithMany()
                    ...
                    b.HasOne("AgileStudioServer.CoreFeatures.Workflows.Repositories.Entities.Workflow", "Workflow")
                        .WithMany()
            ...
            modelBuilder.Entity("AgileStudioServer.CoreFeatures.BacklogItems.Repositories.Entities.ChildBacklogItemType", b =>
                {
                    b.HasOne("AgileStudioServer.CoreFeatures.BacklogItems.Repositories.Entities.BacklogItemType", "ChildType")
                        .WithMany()
                    ...
                    b.HasOne("AgileStudioServer.CoreFeatures.BacklogItems.Repositories.Entities.BacklogItemType", "ParentType")
                        .WithMany()
                    ...
                    b.HasOne("AgileStudioServer.CoreFeatures.BacklogItems.Repositories.Entities.BacklogItemTypeSchema", "Schema")
                        .WithMany()
