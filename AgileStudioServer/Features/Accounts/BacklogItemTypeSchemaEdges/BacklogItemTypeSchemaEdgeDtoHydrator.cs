...
namespace AgileStudioServer.Features.Accounts.BacklogItemTypeSchemaEdges
{
    public class BacklogItemTypeSchemaEdgeDtoHydrator : AbstractDtoHydrator
    {
        ...
        public override object Hydrate(object from, Type to, int maxDepth, int depth, IHydrator? referenceHydrator = null)
        {
            ...
            if (model != null)
            {
                var schemaSummaryDto = (BacklogItemTypeSchemaSummaryDto)referenceHydrator.Hydrate(
                    model.SchemaID, typeof(BacklogItemTypeSchemaSummaryDto), maxDepth, depth
                );
                ...
                dto = new BacklogItemTypeSchemaEdgeDto(
                    model.ID, schemaSummaryDto, fromTypeSummaryDto, toTypeSummaryDto, model.CreatedOn);
