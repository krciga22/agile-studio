...
namespace AgileStudioServer.Migrations
{
    ...
    [Migration("20260619232157_AddBacklogItemTypeSchemaEdge")]
    partial class AddBacklogItemTypeSchemaEdge
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AgileStudioServer.Features.Accounts.BacklogItemTypeSchemaEdges.BacklogItemTypeSchemaEdge", b =>
                {
                    ...
                    b.HasIndex("SchemaID")
                        .HasDatabaseName("ix_backlog_item_type_schema_edge_schema_id");

                    b.HasIndex("ToTypeID")
                        .HasDatabaseName("ix_backlog_item_type_schema_edge_to_type_id");

                    b.ToTable("backlog_item_type_schema_edge", "accounts");
                });

            modelBuilder.Entity("AgileStudioServer.Features.Accounts.BacklogItemTypeSchemaEntries.BacklogItemTypeSchemaEntry", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("ID")
                        .HasName("pk_backlog_item_type_schema_entry");

                    b.HasIndex("ChildTypeID")
                        .HasDatabaseName("ix_backlog_item_type_schema_entry_child_type_id");

                    b.HasIndex("CreatedByID")
                        .HasDatabaseName("ix_backlog_item_type_schema_entry_created_by_id");

                    b.HasIndex("ParentTypeID")
                        .HasDatabaseName("ix_backlog_item_type_schema_entry_parent_type_id");

                    b.HasIndex("SchemaID")
                        .HasDatabaseName("ix_backlog_item_type_schema_entry_schema_id");

                    b.ToTable("backlog_item_type_schema_entry", "accounts");
                });
            ...
            modelBuilder.Entity("AgileStudioServer.Features.Accounts.BacklogItemTypeSchemaNodes.BacklogItemTypeSchemaNode", b =>
                {
                    ...
                    b.HasIndex("SchemaID")
                        .HasDatabaseName("ix_backlog_item_type_schema_node_schema_id");
            ...
            modelBuilder.Entity("AgileStudioServer.Features.Accounts.BacklogItemTypeSchemaEntries.BacklogItemTypeSchemaEntry", b =>
                {
                    ...
                    b.HasOne("AgileStudioServer.Features.Users.Users.User", "CreatedBy")
                        .WithMany()
                        .HasForeignKey("CreatedByID")
                        .HasConstraintName("fk_backlog_item_type_schema_entry_user_created_by_id");
