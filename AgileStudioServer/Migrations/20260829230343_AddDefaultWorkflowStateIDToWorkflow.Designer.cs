...
namespace AgileStudioServer.Migrations
{
    ...
    [Migration("20260829230343_AddDefaultWorkflowStateIDToWorkflow")]
    partial class AddDefaultWorkflowStateIDToWorkflow
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AgileStudioServer.Features.Accounts.Workflows.Workflow", b =>
                {
                    ...
                    b.Property<int?>("DefaultWorkflowStateID")
                        .HasColumnType("integer")
                        .HasColumnName("default_workflow_state_id");
                    ...
                    b.HasIndex("DefaultWorkflowStateID")
                        .HasDatabaseName("ix_workflow_default_workflow_state_id");
            ...
            modelBuilder.Entity("AgileStudioServer.Features.Auth.RolePermissions.RolePermission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            RoleKey = "projects-project-admin",
                            PermissionKey = "list",
                            Scope = "project.backlogItemStatus",
            ...
            modelBuilder.Entity("AgileStudioServer.Features.Projects.BacklogItemLinks.BacklogItemLink", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("SourceBacklogItemID")
                        .HasColumnType("integer")
                        .HasColumnName("source_backlog_item_id");

                    b.Property<int>("TargetBacklogItemID")
                        .HasColumnType("integer")
                        .HasColumnName("target_backlog_item_id");

                    b.HasKey("ID")
                        .HasName("pk_backlog_item_link");

                    b.HasIndex("BacklogItemLinkTypeID")
                        .HasDatabaseName("ix_backlog_item_link_backlog_item_link_type_id");

                    b.HasIndex("CreatedByID")
                        .HasDatabaseName("ix_backlog_item_link_created_by_id");

                    b.HasIndex("SourceBacklogItemID")
                        .HasDatabaseName("ix_backlog_item_link_source_backlog_item_id");

                    b.HasIndex("TargetBacklogItemID")
                        .HasDatabaseName("ix_backlog_item_link_target_backlog_item_id");

                    b.ToTable("backlog_item_link", "projects");
                });
            ...
            modelBuilder.Entity("AgileStudioServer.Features.Accounts.Workflows.Workflow", b =>
                {
                    ...
                    b.HasOne("AgileStudioServer.Features.Accounts.WorkflowStates.WorkflowState", "DefaultWorkflowState")
                        .WithMany()
                        .HasForeignKey("DefaultWorkflowStateID")
                    ...
                    b.Navigation("DefaultWorkflowState");
                });
            ...
            modelBuilder.Entity("AgileStudioServer.Features.Projects.BacklogItemLinks.BacklogItemLink", b =>
                {
                    ...
                    b.HasOne("AgileStudioServer.Features.Users.Users.User", "CreatedBy")
                        .WithMany()
                        .HasForeignKey("CreatedByID")
                        .HasConstraintName("fk_backlog_item_link_user_created_by_id");

                    b.HasOne("AgileStudioServer.Features.Projects.BacklogItems.BacklogItem", "SourceBacklogItem")
                        .WithMany()
                        .HasForeignKey("SourceBacklogItemID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_backlog_item_link_source_backlog_item_id");

                    b.HasOne("AgileStudioServer.Features.Projects.BacklogItems.BacklogItem", "TargetBacklogItem")
                        .WithMany()
                        .HasForeignKey("TargetBacklogItemID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                    ...
                    b.Navigation("SourceBacklogItem");

                    b.Navigation("TargetBacklogItem");
                });
